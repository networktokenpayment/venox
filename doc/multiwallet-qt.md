...
In order to support loading of multiple wallets in venox-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is venox.cpp.
...
Changes to venox.cpp
----------------------
venox.cpp is the entry point into venox-qt, and as such, will require some minor modifications to provide hooks for
