Contributing to Venox Core
============================

The Venox Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Venox Core project, and is not to be
confused with overall Venox Network Protocol consensus changes.

Whether a pull request is merged into Venox Core rests with the project merge
...
Patches that change Venox consensus rules are considerably more involved than
...
Where a patch set proposes to change the Venox consensus, it must have been
...
The project leader is the release manager for each Venox Core release.
