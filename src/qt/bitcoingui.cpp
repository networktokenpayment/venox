                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Venox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview_closed"), tr("&Overview"), this);
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send_closed"), tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a Venox address"));
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses_closed"), tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and venox: URIs)"));
    ...
    historyAction = new QAction(QIcon(":/icons/history_closed"), tr("&Transactions"), this);
    ...
    privacyAction = new QAction(QIcon(":/icons/privacy_closed"), tr("&Privacy"), this);
    privacyAction->setStatusTip(tr("Privacy Actions for zVNX"));
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/masternodes_closed"), tr("&Masternodes"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Venox"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Venox addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Venox addresses"));
    ...
    openAction->setStatusTip(tr("Open a Venox: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Venox Core help message to get a list with possible Venox command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Venox Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Venox network", "", count));
}
...
{
    QString strTitle = tr("Venox Core"); // default title
