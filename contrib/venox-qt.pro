...
RESOURCES += src/qt/venox.qrc src/qt/venox_locale.qrc

TRANSLATIONS += src/qt/locale/venox_bg.ts \
                src/qt/locale/venox_de.ts \
                src/qt/locale/venox_en.ts \
                src/qt/locale/venox_es.ts \
                src/qt/locale/venox_fi.ts \
                src/qt/locale/venox_fr.ts \
                src/qt/locale/venox_it.ts \
                src/qt/locale/venox_ja.ts \
                src/qt/locale/venox_pl.ts \
                src/qt/locale/venox_pt.ts \
                src/qt/locale/venox_ru.ts \
                src/qt/locale/venox_sk.ts \
                src/qt/locale/venox_sv.ts \
                src/qt/locale/venox_vi.ts \
                src/qt/locale/venox_zh_CN.ts \
                src/qt/locale/venox_zh_TW.ts
