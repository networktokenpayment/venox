...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Venox features */
        {"venox", "masternode", &masternode, true, true, false},
        {"venox", "listmasternodes", &listmasternodes, true, true, false},
        {"venox", "getmasternodecount", &getmasternodecount, true, true, false},
        {"venox", "masternodeconnect", &masternodeconnect, true, true, false},
        {"venox", "masternodecurrent", &masternodecurrent, true, true, false},
        {"venox", "masternodedebug", &masternodedebug, true, true, false},
        {"venox", "startmasternode", &startmasternode, true, true, false},
        {"venox", "createmasternodekey", &createmasternodekey, true, true, false},
        {"venox", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"venox", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"venox", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"venox", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"venox", "getmasternodescores", &getmasternodescores, true, true, false},
        {"venox", "mnbudget", &mnbudget, true, true, false},
        {"venox", "preparebudget", &preparebudget, true, true, false},
        {"venox", "submitbudget", &submitbudget, true, true, false},
        {"venox", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"venox", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"venox", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"venox", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"venox", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"venox", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"venox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"venox", "checkbudgets", &checkbudgets, true, true, false},
        {"venox", "mnsync", &mnsync, true, true, false},
        {"venox", "spork", &spork, true, true, false},
        {"venox", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"venox", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use venoxd, or the -server option to venox-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> venox-cli " + methodname + " " + args + "\n";
}
