...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    result.emplace_back(Pair("zVNXsupply", zcivObj));
...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in venox\n"
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of venox addresses\n"
            "     \"venoxaddress\"   	 	(string) venox address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
    ...
    Object o;
    ScriptPubKeyToJSON(coins.vout[n].scriptPubKey, coins.vout[n].receiverPubKey, o, true);
