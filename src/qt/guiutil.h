...
/** Utility functions used by the Venox Qt UI.
 */
namespace GUIUtil
{
...
// Render Venox addresses in monospace font
...
// Parse "venox:" URI into recipient object, return true on successful parsing
