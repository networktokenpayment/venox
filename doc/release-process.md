...
### Build and sign Venox Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit venox=v${VERSION} ../venox/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [venox-detached-sigs](https://github.com/venox-team/venox-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/venox-team/Venox/releases/new) with a link to the archived release notes.
