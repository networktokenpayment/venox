...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000af75c4b0d0ee438b2d659861a37ff9dd1942068970c20ecb04cdf791149"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1529153612, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0442a5a7a9af40a5d9f3793f0c4bdea015fc1cdc09ead46f0e81d849e6001aa303b06519ce91db364bdb2de217d6a82784f5828c0059e490808ae331f358caf6b8");
        nDefaultPort = 1589;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Venox starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Venox: 1 day
        nTargetSpacing = 2 * 60;  // Venox: 2 minute
        nMaturity = 10;
        ...
        const char* pszTimestamp = "Forget Enox The Scam - We Are Venox Now - 2018";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].referenceline = "";
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04bf54997d91817589e4ecf6298944fdee2985257dfde19796a3adf28c003510740f384b0d50a1aed43b027d26648c1a3ba2447aad6f10096c6f06d8a20556b8d7") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1529153612;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4567354;
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("047e24cfddc91c39fe35d6cb6d8adef951de6f105b18c24ffc4015785d7894493a3f464c82d1c2fc37e63ef6176b891408dcb2c57b4c97f8ffb6ac5dd00d614cfd");
        nDefaultPort = 51434;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Venox: 1 day
        nTargetSpacing = 1 * 15;  // Venox: 15 seconds
        nLastPOWBlock = 200;
        nMaturity = 2;
  	...
  	hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet venox addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet venox script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet venox BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet venox BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet venox BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Venox: 1 day
        nTargetSpacing = 1 * 60;        // Venox: 1 minutes
